...
resnet.load_weights('save/save_senetresnet_2019-5-29.h5')
...
#         training = resnet.fit(x_train, y_train, epochs=2, batch_size=56, shuffle=True)
#         now = datetime.now()
#         temp = ('%s-%s-%s'%(now.year, now.month, now.day))
#         resnet.save_weights('save/save_senetresnet_'+temp+'.h5')
